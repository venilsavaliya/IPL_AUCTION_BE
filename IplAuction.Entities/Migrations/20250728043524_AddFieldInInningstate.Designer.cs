...
namespace IplAuction.Entities.Migrations
{
    ...
    [Migration("20250728043524_AddFieldInInningstate")]
    partial class AddFieldInInningstate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 28, 4, 35, 22, 394, DateTimeKind.Utc).AddTicks(3626),
                            ...
                            PasswordHash = "$2a$11$sfhMmJOfPybhyN6HBhrA2u78jXii8JC4qZ3iRMuWmpSi8S1v2Yjjm",
                            Role = "Admin"
                        });
                });
