...
namespace IplAuction.Entities.Migrations
{
    ...
    [Migration("20250805113546_MAkeDobNullableInPlayer")]
    partial class MAkeDobNullableInPlayer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 5, 11, 35, 44, 398, DateTimeKind.Utc).AddTicks(7432),
                            ...
                            PasswordHash = "$2a$11$8MXTKo0x4/IBcf9Yfpxt5eZ9ASiUldkW/dLMfecGDucVBUQKVbIcK",
                            Role = "Admin"
                        });
                });
