...
namespace IplAuction.Entities.Migrations
{
    ...
    [Migration("20250820084835_AddUserTeamMatch")]
    partial class AddUserTeamMatch
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 20, 8, 48, 33, 664, DateTimeKind.Utc).AddTicks(7080),
                            ...
                            PasswordHash = "$2a$11$2NMZKk86ggnUl68t74i15OXwSEOcmgqwA3xWyQOEt.Iv4pOGq2cAG",
                            Role = "Admin"
                        });
                });
