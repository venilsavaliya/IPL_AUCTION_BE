...
namespace IplAuction.Entities.Migrations
{
    ...
    [Migration("20250818091529_AddOrderNumberField")]
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 18, 9, 15, 27, 237, DateTimeKind.Utc).AddTicks(7793),
                            ...
                            PasswordHash = "$2a$11$y9UL.6rJnwRpysqSCrPckubR7iIbKUVX9qtLpJs1NHc8uSCrF7eca",
                            Role = "Admin"
                        });
                });
