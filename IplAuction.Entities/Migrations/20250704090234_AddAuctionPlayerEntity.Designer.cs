...
namespace IplAuction.Entities.Migrations
{
    ...
    [Migration("20250704090234_AddAuctionPlayerEntity")]
    partial class AddAuctionPlayerEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 4, 9, 2, 32, 645, DateTimeKind.Utc).AddTicks(2177),
                            ...
                            PasswordHash = "$2a$11$PabXM/.VHjkpq33WH5/ILuWMsNSfY9V52iwsrFshwRb29EUUG1fWq",
                            Role = "Admin"
                        });
                });
