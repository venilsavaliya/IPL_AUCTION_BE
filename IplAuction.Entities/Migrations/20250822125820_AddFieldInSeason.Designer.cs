...
namespace IplAuction.Entities.Migrations
{
    ...
    [Migration("20250822125820_AddFieldInSeason")]
    partial class AddFieldInSeason
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.Season", b =>
                {
                    ...
                    b.Property<bool>("IsSeasonStarted")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 22, 12, 58, 18, 188, DateTimeKind.Utc).AddTicks(2257),
                            ...
                            PasswordHash = "$2a$11$IrSdJdXrwv4eeKCU67rO8.K34MO9c5ApxjwA4aa3pdTDmWqjjP2T6",
                            Role = "Admin"
                        });
                });
