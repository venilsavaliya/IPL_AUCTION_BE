...
namespace IplAuction.Entities.Migrations
{
    ...
    [Migration("20250801061716_MakeSeasonIdNotNullInAuction")]
    partial class MakeSeasonIdNotNullInAuction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 1, 6, 17, 13, 857, DateTimeKind.Utc).AddTicks(7503),
                            ...
                            PasswordHash = "$2a$11$k7yI9KbIAjNDM8MWglhtgulppLGlo92an5WOzARbE8r78rZKuGJZO",
                            Role = "Admin"
                        });
                });
