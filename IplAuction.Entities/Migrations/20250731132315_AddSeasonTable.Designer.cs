...
namespace IplAuction.Entities.Migrations
{
    ...
    [Migration("20250731132315_AddSeasonTable")]
            ...
            modelBuilder.Entity("IplAuction.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 31, 13, 23, 14, 429, DateTimeKind.Utc).AddTicks(7188),
                            ...
                            PasswordHash = "$2a$11$jnvjBWdcfBvXM5rVFx6zP.sGbZHpRBMk3OglrlhIDCQVfoj944Jiq",
                            Role = "Admin"
                        });
                });
